...
import { getMediaSignedUrl, getMediaUrlById } from '@/lib/mediaStorage';
  ...
  useEffect(() => {
    ...
    async function hydrate() {
      ...
      if (isEmptySlideContent(content)) {
        ...
        backgroundMediaIdRef.current = bgMediaId;

        // Slides generated by Songs/Bible/Media set meta.backgroundMediaId
        // without a live-canvas-serialized backgroundImage — resolve and
        // apply it now so it renders.
